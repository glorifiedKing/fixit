         ...
         <div class="row">
           <div class="col-sm-3">
             <div class="form-group {{ $errors->has('userid') ? ' has-error' : '' }}">
                 ...
                 <input readonly type="text" name="userid"  value="{{ $user->userid }}" class="form-control"  >
           ...
           <div class="col-sm-3">
             <div class="form-group {{ $errors->has('realname') ? ' has-error' : '' }}">
                 ...
                 <input type="text" name="realname"  value="{{ $user->realname }}" class="form-control"  required>
                 @if ($errors->has('price'))
                     <span class="alert-danger">
